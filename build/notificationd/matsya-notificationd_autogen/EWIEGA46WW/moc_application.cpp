...
#include <memory>
#include "../../../../notificationd/application.h"
...
QT_MOC_LITERAL(1, 12, 19), // "doNotDisturbChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 12) // "doNotDisturb"

    },
    "Application\0doNotDisturbChanged\0\0"
    "doNotDisturb"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Application::doNotDisturbChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Application::doNotDisturbChanged()
{
