...
{
    // handle method call com.cutefish.Session.launch
...
{
    // handle method call com.cutefish.Session.logout
    parent()->logout();
}

void SessionAdaptor::powerOff()
{
    // handle method call com.cutefish.Session.powerOff
    parent()->powerOff();
}

void SessionAdaptor::reboot()
{
    // handle method call com.cutefish.Session.reboot
    parent()->reboot();
}

void SessionAdaptor::startDesktopProcess()
{
    // handle method call com.cutefish.Session.startDesktopProcess
    parent()->startDesktopProcess();
}

void SessionAdaptor::suspend()
{
    // handle method call com.cutefish.Session.suspend
    parent()->suspend();
}

void SessionAdaptor::updateNetworkProxy()
{
    // handle method call com.cutefish.Session.updateNetworkProxy
