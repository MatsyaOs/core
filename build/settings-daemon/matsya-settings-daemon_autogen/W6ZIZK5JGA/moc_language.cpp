...
QT_MOC_LITERAL(1, 9, 15), // "languageChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "languageCode"

    },
    "Language\0languageChanged\0\0languageCode"
};
...
void Language::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Language::languageChanged)) {
                *result = 0;
                return;
            }
        }
