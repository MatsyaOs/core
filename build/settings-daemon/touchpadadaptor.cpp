...
{
    // handle method call com.cutefish.Touchpad.setEnabled
    parent()->setEnabled(enabled);
}

void TouchpadAdaptor::setNaturalScroll(bool enabled)
{
    // handle method call com.cutefish.Touchpad.setNaturalScroll
    parent()->setNaturalScroll(enabled);
}

void TouchpadAdaptor::setPointerAcceleration(double value)
{
    // handle method call com.cutefish.Touchpad.setPointerAcceleration
    parent()->setPointerAcceleration(value);
}

void TouchpadAdaptor::setTapToClick(bool enabled)
{
    // handle method call com.cutefish.Touchpad.setTapToClick
