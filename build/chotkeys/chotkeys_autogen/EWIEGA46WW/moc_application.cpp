...
#include <memory>
#include "../../../../chotkeys/application.h"
...
QT_MOC_LITERAL(3, 23, 6), // "keySeq"
QT_MOC_LITERAL(4, 30, 10) // "onReleased"

    },
    "Application\0onPressed\0\0keySeq\0onReleased"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onPressed((*reinterpret_cast< QKeySequence(*)>(_a[1]))); break;
        case 1: _t->onReleased((*reinterpret_cast< QKeySequence(*)>(_a[1]))); break;
        default: ;
        }
    }
}
