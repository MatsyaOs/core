...
void Clipboard::onDataChanged()
{
    ...
    if (mimeData->hasFormat("application/x-matsya-clipboard") &&
            mimeData->data("application/x-matsya-clipboard") == "1")
        return;
    ...
    // matsya flag.
    newMimeData->setData("application/x-matsya-clipboard", QByteArray("1"));
