...
//    , m_kwinTimer(new QTimer(this))
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("com.matsya.Settings"));
...
//    m_kwinTimer->start();
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/matsya-settings-daemon/translations/").arg(locale.name());
...
void Application::invokeDesktopProcess()
{
    ...
    QDBusInterface sessionInterface("com.matsya.Session", "/Session", "com.matsya.Session",
...
//        effect.call("loadEffect", "matsya_popups");
//        effect.call("loadEffect", "matsya_scale");
//        effect.call("loadEffect", "matsya_squash");
